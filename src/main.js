import './style.css';
const PROFILE = {"day":"Day077","title":"Pan Size Ratio Converter","display_name_ja":"型サイズ換算カード","one_sentence":"レシピの型サイズや人数差を、分量と焼き時間の目安カードに直すツール","purpose_line_ja":"型違いのレシピ分量を直すためのツールです。","use_case_line_ja":"手元の型がレシピと違う時に使います。","how_it_works_line_ja":"型と分量を入れると、倍率が出ます。","core_action":"convert","family":"pan_ratio_convert","mechanic":"swap_compare","input_style":"recipe_rows","output_style":"ratio_cards","output_label":"ここを見ればOKです","audience_promise":"作り始める前に失敗しにくい量へ直せる。","publish_hook":"元の型と手元の型を入れるだけで、分量倍率と注意点がすぐ見える。","engine":"brief_driven","interaction_archetype":"swap_compare","page_archetype":"comparison_table","ui_variant":"recipe","intro_variant":"pan_ratio_cards","interaction_model":"editable_pan_sizes_to_ratio_cards","primary_layout":"pan_size_editor_with_ratio_result","result_presentation_style":"ratio_formula_cards_and_baking_warning","palette_motif":"レシピ型換算ベリー","main_cta":"手元の型で試す","input_panel_title":"元の型と手元の型を足す","sample_panel_title":"手元の型で試す","guide_panel_title":"倍率と焼き時間の見どころ","hero_panel_label":"型サイズの倍率","output_shape":"comparison_table","state_model":"swap_compare_state","core_loop":"recipe_rows -> swap_compare -> ratio_cards","component_pack":"comparison_table+ratio_cards","scaffold_id":"brief_canvas","single_shot_text_generator":false};
